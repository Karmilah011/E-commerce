...
@section('title', 'Admin Transaction Waiting To Payment')
                        ...
                        <div class="white_card_body">
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    <h4>Table Waiting Payemnt</h4>
                                    <div class="box_right d-flex lms_block">
                                        <div class="serach_field_2">
                                            <div class="search_inner">
                                                <form action="{{ route('admin.waitingToPayment') }}" method="GET">
                                                ...
                                                @foreach ($waiting as $value)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <th scope="row" tabindex="0" class="sorting_1">
                                                            {{ $value->address }}</th>
                                                        <td>
                                                            <a href="{{route('admin.showData',['status'=>'waiting','process_code'=>$value->process_code])}}" class="btn btn-primary btn-sm">Show</a>
                                                            <a href="{{route('admin.updateStatus',['process_code'=>$value->process_code,'status'=>'packed'])}}" class="btn btn-success btn-sm">Next To Packed</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
