...
@section('title', 'Admin Transaction Finsh')
                                    ...
                                    <div class="box_right d-flex lms_block">
                                        <div class="serach_field_2">
                                            <div class="search_inner">
                                                <form action="{{ route('admin.finish') }}" method="GET">
                                                ...
                                                @foreach ($finish as $value)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <th scope="row" tabindex="0" class="sorting_1">
                                                            {{ $value->address }}</th>
                                                        <td>
                                                            <a href="{{route('admin.showData',['status'=>'finish','process_code'=>$value->process_code])}}" class="btn btn-primary btn-sm">Show</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
