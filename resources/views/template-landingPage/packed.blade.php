...
@section('content')
    ...
    <section class="shopping-cart spad">
        <div class="container">
            @foreach ($processCodePacked as $processCode)
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="shopping__cart__table">
                            ...
                            <span>ID Transaction : <a href="{{route('invoice',['status'=>'packed','process_code'=>$item->process_code])}}">{{$item->process_code}}</a></span> <br>
                        </div>
                    </div>
                    <hr>
                </div>
            @endforeach
            @if (count($processCodePacked) == 0)
