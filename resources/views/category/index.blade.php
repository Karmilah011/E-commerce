                            ...
                            <div class="white_box_tittle list_header">
                                ...
                                <div class="box_right d-flex lms_block">
                                    ...
                                    <div class="add_button ms-2">
                                        <a href="{{route('category.create')}}" data-bs-toggle="modal" data-bs-target="#addcategory" class="btn btn-success">Add New</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table lms_table_active dataTable no-footer dtr-inline" id="DataTables_Table_0"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th scope="col" class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    aria-label="title: activate to sort column descending">Name Category</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a href="{{route('category.destroy', $value->id)}}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this category?')">Delete</a></td>
                                            </tr>  
                                            @endforeach
                                        </tbody>
                                    </table>
